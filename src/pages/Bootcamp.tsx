  ...
  return (
    <div className="container py-12">
      <header className="grid gap-3">
        <h1 className="text-3xl font-semibold tracking-tight">Student Bootcamp</h1>
        <p className="max-w-2xl text-muted-foreground">
          A cohort-based program focused on structure, discipline, and risk management.
        </p>
      </header>
          ...
          <Card>
            ...
            <CardContent className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
              {[
                ...
                <div key={m} className="rounded-md border bg-card px-3 py-2">
                  {m}
                </div>
              ))}
            </CardContent>
