            ...
            <Card key={forecast.id} className="overflow-hidden">
              <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                <CardContent className="space-y-5 pt-6">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs"><Badge variant="outline">{forecast.source_type === "live_chart" ? "Live chart setup" : "Screenshot setup"}</Badge>{forecast.exchange ? <Badge variant="outline">{forecast.exchange}</Badge> : null}{forecast.timeframe ? <Badge variant="outline">{timeframeLabels[forecast.timeframe] ?? forecast.timeframe}</Badge> : null}</div>
